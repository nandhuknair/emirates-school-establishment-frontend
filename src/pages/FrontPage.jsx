...
import { EyeOff, Eye, Delete } from "lucide-react";
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2">
                <div className="flex-grow flex items-center justify-between
                 bg-[#F5ECE6] border-transparent focus:border-[#B2B0A1] focus:ring-[#B2B0A1] placeholder-[#A9A7A0] text-[#6E6658] rounded-md p-2 outline-none text-sm">
                <input
                  type="text"
